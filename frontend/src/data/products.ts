...
export const getProducts = (): Product[] => {
  ...
  const householdItems = [
    ...
    {
      name: "مكنسة دايسون V15 Detect اللاسلكية الذكية بخرائط ليزر",
      basePrice: 1450,
    },
    {
      name: "قلاية فيليبس Airfryer Premium الهوائية الرقمية XXL",
      basePrice: 450,
    },
    {
      name: "جهاز منقي الهواء دايسون Purifier Cool بالفلاتر المتطورة",
      basePrice: 899,
    },
    { name: "مروحة دايسون Cool AM07 الذكية بدون شفرات هادئة", basePrice: 599 },
    {
      name: "مكواة البخار العمودية الاحترافية تيفال Pro Style",
      basePrice: 349,
    },
    ...
    {
      name: "جهاز طهي الأرز الفوري Instant Pot Duo Crisp متعدد الوظائف",
      basePrice: 299,
    },
    {
      name: "موزع ومبرد مياه فيليبس الذكي المزود بفلاتر متقدمة",
      basePrice: 650,
    },
    { name: "مكيف هواء سبليت دايكن ذكي موفر للطاقة بلس", basePrice: 3200 },
    {
      name: "دفاسة ديلونجي الرقمية بالأشعة تحت الحمراء مع مؤقت",
      basePrice: 420,
    },
    {
      name: "مستشعر كشف الغاز والحرائق الذكي جوجل نيست بروتكت",
      basePrice: 180,
    },
    { name: "ميزان حرارة ورطوبة الغرفة الذكي شاومي الرقمي", basePrice: 99 },
    {
      name: "مكواة فيليبس Azur Elite الذكية المضادة للحرق بالكامل",
      basePrice: 249,
    },
    ...
    {
      name: "موزع صابون السائل سيمبلهيومان الأوتوماتيكي بالاستشعار",
      basePrice: 89,
    },
    { name: "مصباح مكتب ذكي بينكيو مع شاحن لاسلكي حامي للعين", basePrice: 159 },
    {
      name: "سلة مهملات ذكية سيمبلهيومان العاملة بالاستشعار الفوري",
      basePrice: 129,
    },
    {
      name: "مبخرة الشايع الكهربائية الذكية المحمولة للشحن والرحلات",
      basePrice: 79,
    },
    { name: "مرطب وموزع الروائح العطرية شاومي الذكي المتصل", basePrice: 139 },
    {
      name: "جهاز غسيل الخضار والفواكه بالموجات الصوتية والأوزون",
      basePrice: 320,
    },
    ...
    {
      name: "غلاية مياه كهربائية زجاجية فيليبس بإضاءة LED ملونة",
      basePrice: 179,
    },
    ...
    {
      name: "فرشاة أسنان أورال-بي iO Series 9 الكهربائية بالموجات",
      basePrice: 199,
    },
    {
      name: "مجفف ومجفف اليدين الأوتوماتيكي دايسون Airblade السريع",
      basePrice: 480,
    },
    {
      name: "مجفف الشعر الأيوني دايسون Supersonic عالي السرعة",
      basePrice: 299,
    },
  ...
  const phoneItems = [
    ...
    {
      name: "هاتف جالاكسي Z Fold 5 ذو الشاشة القابلة للطي 120 هرتز",
      basePrice: 3899,
    },
    {
      name: "هاتف آسوس ROG Phone 8 Pro المخصص للألعاب القوية",
      basePrice: 1299,
    },
    {
      name: "ساعة أبل الذكية Apple Watch Ultra 2 بنظام تحديد المواقع",
      basePrice: 799,
    },
    {
    ...
    {
      name: "جهاز تتبع الأغراض والمفاتيح أبل AirTag ذو التوجيه الدقيق",
      basePrice: 199,
    },
    {
      name: "قاعدة شحن بيلكين اللاسلكي السريع 3 في 1 بقوة 15 واط",
      basePrice: 149,
    },
    {
      name: "شاحن متنقل أنكر PowerCore فائق السرعة 20,000 ملي أمبير",
      basePrice: 1999,
    },
    {
      name: "نظارات الواقع الافتراضي ميتا كويست 3 المستقلة بالكامل",
      basePrice: 499,
    },
    {
      name: "الخاتم الذكي Oura Ring Gen 3 لتتبع النوم ومعدل ضربات القلب",
      basePrice: 449,
    },
    {
      name: "مثبت كاميرا وموازنة الهواتف الذكية DJI Osmo Mobile 6",
      basePrice: 299,
    },
    {
      name: "ميكروفون لاسلكي ذكي رود Wireless GO II لصناع المحتوى",
      basePrice: 599,
    },
    {
      name: "سبيكر مكبر صوت بلوتوث سوني SRS-XB100 مقاوم للماء",
      basePrice: 249,
    },
    {
      name: "جهاز الترجمة الفورية الصوتي فواسكا بـ 106 لغات مختلفة",
      basePrice: 189,
    },
    {
      name: "جهاز كشف كاميرات المراقبة والخصوصية الاحترافي المحمول",
      basePrice: 129,
    },
    {
      name: "لوحة مفاتيح لوجيتك MX Keys Mini اللاسلكية المحمولة",
      basePrice: 220,
    },
    {
      name: "محول بث التلفاز والوسائط Xiaomi TV Box S 4K الذكي",
      basePrice: 159,
    },
    {
      name: "ساعة منبهة ذكية فيليبس Wake-up Light بمحاكاة الشروق",
      basePrice: 99,
    },
  ];
  ...
  const computerItems = [
    ...
    {
      name: "حاسوب محمول ديل XPS 15 المتميز للأعمال والمبدعين",
      basePrice: 7499,
    },
    {
      name: "حاسوب أبل آي ماك متكامل شاشة 24 بوصة Retina 4.5K",
      basePrice: 8499,
    },
    {
      name: "لابتوب ألعاب خارق آسوس ROG Strix SCAR 17 بمعالج i9",
      basePrice: 3500,
    },
    {
      name: "شاشة كمبيوتر منحنية سامسونج Odyssey Neo G9 مقاس 49 بوصة",
      basePrice: 399,
    },
    {
      name: "لوحة مفاتيح ميكانيكية لوجيتك G915 TKL بإضاءة RGB",
      basePrice: 249,
    },
    {
      name: "فأرة ألعاب لاسلكية فائقة الدقة لوجيتك G Pro X Superlight 2",
      basePrice: 699,
    },
    {
      name: "قرص تخزين خارجي سامسونج T7 Shield مقاوم للصدمات 2 تيرابايت",
      basePrice: 450,
    },
    {
      name: "سماعة رأس لاسلكية محيطية ستيل سيريس Arctis Nova Pro",
      basePrice: 380,
    },
    {
      name: "كاميرا ويب ذكية لوجيتك Brio بدقة 4K فائقة الوضوح",
      basePrice: 899,
    },
    {
      name: "جهاز توجيه راوتر أسوس ROG Rapture GT6 ثلاثي النطاق",
      basePrice: 1299,
    },
    {
      name: "طابعة ليزرية ملونة متعددة الوظائف إتش بي LaserJet Pro",
      basePrice: 149,
    },
    {
      name: "قاعدة تبريد لابتوب تارغوس مع مراوح مزدوجة صامتة جداً",
      basePrice: 650,
    },
    {
      name: "جهاز التقاط وبث ألعاب إلغاتو Elgato Game Capture 4K60 S+",
      basePrice: 229,
    },
    {
      name: "ذراع تحكم احترافية للكمبيوتر مايكروسوفت Xbox Elite Series 2",
      basePrice: 899,
    },
    {
      name: "لوح رسم رقمي واكوم Intuos Pro للمصممين مع قلم حساس",
      basePrice: 279,
    },
    {
      name: "قاعدة توصيل يو إس بي سي أنكر 11 في 1 للابتوب الفاخرة",
      basePrice: 499,
    },
    {
      name: "نظام تبريد مائي مغلق كورسير iCUE H150i Elite للمعالجات",
      basePrice: 599,
    },
    {
      name: "ذاكرة عشوائية كورسير Vengeance RGB DDR5 سعة 32 جيجابايت",
      basePrice: 650,
    },
    {
      name: "كرت صوت خارجي احترافي فوكوسرايت Scarlett 2i2 للتسجيل",
      basePrice: 799,
    },
  ];
...
export const INITIAL_PRODUCTS = getProducts();
